...
// import houseData
import { housesData, tabs1, tabs2 } from "../data";
//  useParams
    ...
    <>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          <div className="max-w-[768px]">
            ...
            <div className="mb-8">
              <div>
                ...
                <FsLightbox
                  toggler={toggler}
                  sources={[property.carouselData[index].image]}
                />
              </div>
            </div>
          ...
          <div className="fbg-white border border-gray-300 flex-1 mb-8 px-6 py-8 rounded-lg sticky top-20 w-full ">
